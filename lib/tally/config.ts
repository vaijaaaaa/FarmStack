...
// GST ledger names. These ledgers must already exist in TallyPrime (FarmStack
// also creates them automatically before posting a voucher).
//   Local supply  => CGST + SGST   Interstate supply => IGST
